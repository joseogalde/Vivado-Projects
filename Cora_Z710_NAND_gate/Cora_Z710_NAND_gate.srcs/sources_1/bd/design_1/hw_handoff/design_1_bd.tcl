...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports btn0] [get_bd_pins and_gate_0/a]
  connect_bd_net -net and_gate_0_y [get_bd_pins and_gate_0/y] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports led0_b] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports btn1] [get_bd_pins and_gate_0/b]
